...
//const char* ssid_AP = "Druida Uno"; //HACKEADO
//const char* ssid_AP = "Druida Dos";  //HACKEADO
//const char* ssid_AP = "Druida Tres";  //HACKEADO
//const char* ssid_AP = "Druida Cuatro";  //HACKEADO
//const char* ssid_AP = "Druida Cinco";  //HACKEADO
//const char* ssid_AP = "Druida Seis";  //HACKEADO
//const char* ssid_AP = "Druida Siete"; //HACKEADO
//const char* ssid_AP = "Druida Ocho"; // Esquejes
//const char* ssid_AP = "Druida Nueve"; // (IVANA)
//const char* ssid_AP = "Druida Diez"; // 80 x 80
//const char* ssid_AP = "Druida Once"; // 60 x 60
//const char* ssid_AP = "Druida Doce"; 
//const char* ssid_AP = "Druida Trece"; // Mati Caba
const char* ssid_AP = "Druida Catorce"; // Juampa
